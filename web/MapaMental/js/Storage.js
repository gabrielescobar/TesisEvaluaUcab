    ...
    return decodeURIComponent((new RegExp('[?|&]' + name + '=' + '([^&;]+?)(&|#|;|$)').exec(location.search) || [, ""])[1].replace(/\+/g, '%20')) || null
            ...
            try {
                ...
                $.ajax({
                    url: 'insertMapa.php',
                    type: 'post',
                    data: {"idalumno": getURLParameter('idestudiante'),"estudiante": getURLParameter('estsecc'),"grupo": getURLParameter('estgrupo'), "idasignacion": getURLParameter('idasignacion'), "titulo": prefix + doc.id, "contenido": doc.serialize(),"idmapa" : getURLParameter('idmapa')},
        ...
        loadDocument: function (docId) {
           // return getDocumentByKey(prefix + docId);
             ...
             $.ajax({
                url: 'contenidoMapa.php',
                type: 'post',
                data: {"titulo": prefix + docId},
...
//                     //  alert(this);
//                     documents.push(mindmaps.Document.fromJSON(this));
//                    });
//                    alert(documents)
//                    return documents;
//                }
