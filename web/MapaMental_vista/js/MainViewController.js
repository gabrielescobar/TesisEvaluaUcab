...
mindmaps.MainViewController = function(eventBus, mindmapModel, commandRegistry) {
  ...
  this.go = function() {
    ...
    function getURLParameter(name) {
      ...
      if (getURLParameter('idrubrica') != 0){
$("#statusbar").append('<button onclick="window.open(\'http://evaluaucab.edu//rubricas/public_html/calificar.html?idrubrica='+getURLParameter('idrubrica')+'&idalumno='+getURLParameter('estsecc')+'&idgrupo='+getURLParameter('estgrupo')+'&idasignacion='+getURLParameter('idasignacion')+'&tipo=0\', \'_blank\')" style="line-height:1.4;font-size:14px;margin-top:4px;margin-left:12px;border-radius:4px;font-weight:normal;color:#4F4F4F;font-weight:bold;width:71px;">Calificar</button>');
}
    else if (getURLParameter('idlista') != 0){
$("#statusbar").append('<button onclick="window.open(\'http://evaluaucab.edu//listas/public_html/calificar.html?idlista='+getURLParameter('idrubrica')+'&idalumno='+getURLParameter('estsecc')+'&idgrupo='+getURLParameter('estgrupo')+'&idasignacion='+getURLParameter('idasignacion')+'&tipo=0\', \'_blank\')" style="line-height:1.4;font-size:14px;margin-top:4px;margin-left:12px;border-radius:4px;font-weight:normal;color:#4F4F4F;font-weight:bold;width:71px;">Calificar</button>');
}
