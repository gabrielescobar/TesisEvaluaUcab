...
class MateriaController extends Controller
{
    public function verAction()
    {
        ...
        return $this->render('ProfesorBundle:Default:verMaterias.html.twig',compact('pagination'));
    }
       ...
       public function crearAction()
    {
       ...
       // var_dump($formulario->getErrors());
        ...
        return $this->render('ProfesorBundle:Default:crearMateria.html.twig', array('formulario' => $formulario->createView())
        );
    }
